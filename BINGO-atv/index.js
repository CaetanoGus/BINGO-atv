...
function NumAleatorios(quantidade, min, max){
...
function gerarCartela(){
    ...
    var cartela = [
        NumAleatorios(5,1,15),       
        NumAleatorios(5,16,30), 
        NumAleatorios(5,31,45),
        NumAleatorios(5,46,60), 
        NumAleatorios(5,61,75)
    ]
    ...
    criarCartela(nomeJogador, cartela);
